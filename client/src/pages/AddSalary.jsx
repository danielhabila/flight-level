...
function PostAJob(props) {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      const response = await axios.post("/api/CreateJob", {
        ...formData,
        totalCost,
        productImage, // set image field to first image in productImages array
      });
              ...
              <div className="flex-1 py-8">
                ...
                >
                  <div className="divide-y divide-gray-200 -my-6">
                    ...
                    <div className="py-6">
                      ...
                      <div className="space-y-4">
                        <div>
                          ...
                          <input
                            id="job-title"
                            className="form-input w-full border-0 bg-white/5 text-white shadow-md ring-1 ring-white/10"
                            type="text"
                          ...
                          <div className="my-2 space-x-4 flex">
                            <div className="flex items-center">
                              <input
                                ...
                                onChange={() =>
                                  handleSalaryOptionChange("exact")
                                }
                              />
                            ...
                            <div className="flex items-center">
                              <input
                                ...
                                onChange={() =>
                                  handleSalaryOptionChange("range")
                                }
                              />
                              <label className="ml-3 block text-sm font-medium ">
                                Range
                    ...
                    <div className="py-6">
                      <div className="text-lg font-bold text-gray-800 mb-5">
                        <span className="text-myred">3.</span> Select add-ons
                        and pay
                      </div>
                      <div className="space-y-4">
                        {/* Add-on button #1 *****************************************************/}
                          ...
                          <div className="flex justify-between items-center">
                            <div>
                              <div className="text-sm text-gray-800 font-medium mb-1">
                                Stick your post to stay on top for 24 hours
                                (+49)
                              </div>
